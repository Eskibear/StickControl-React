...
export default [
  ...
  "rlrl s:rrll s:rrl_ | rlrl s:rrll s:rrl_",             // 13
  "lrlr s:llrr s:llr_ | lrlr s:llrr s:llr_",             // 14
  "rrll s:rrll s:rrl_ | rrll s:rrll s:rrl_",              // 15
  "llrr s:llrr s:llr_ | llrr s:llrr s:llr_",              // 16
  "rlrr s:llrr s:llr_ | lrll s:rrll s:rrl_",              // 17
  "rllr s:llrr s:llr_ | lrrl s:rrll s:rrl_",              // 18
  "rrlr s:llrr s:llr_ | llrl s:rrll s:rrl_",              // 19
  "rrrl s:rrll s:rrl_ | rrrl s:rrll s:rrl_",              // 20
  "lllr s:llrr s:llr_ | lllr s:llrr s:llr_",              // 21
  "rlll s:rrll s:rrl_ | rlll s:rrll s:rrl_",              // 22
  "lrrr s:llrr s:llr_ | lrrr s:llrr s:llr_",              // 23
  "rrrr s:llrr s:llr_ | llll s:rrll s:rrl_",              // 24
]
